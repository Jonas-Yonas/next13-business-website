...
import bugFix from "../assets/images/bug-fix.png";
    ...
    <>
      <div className="container px-5 py-14 mx-auto">
        <div className="flex flex-col text-center w-full mb-20">
          <h2 className="text-sm text-purple-500 tracking-widest font-medium">
            ABOUT US
          </h2>
      ...
      <div className="container px-5 py-24 mx-auto flex flex-wrap">
        ...
        <div className="flex flex-col lg:py-6 -mb-10 lg:w-1/2 lg:pl-12">
          {aboutData.map(({ id, title, text, icon }) => (
            ...
            >
              <div className="w-12 h-12 inline-flex items-center justify-center rounded-full bg-purple-200 text-purple-500 mb-5">
                {icon}
              </div>
